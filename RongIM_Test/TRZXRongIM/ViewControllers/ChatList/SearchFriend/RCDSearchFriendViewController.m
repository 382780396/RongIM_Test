...
#import <TRZXDIYRefresh/TRZXGifFooter.h>
...
//        [_searchBar setImage:[UIImage imageNamed:@"RCDSubscription_SearchBar_icon"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
